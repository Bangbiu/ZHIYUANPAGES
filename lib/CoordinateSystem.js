...
import { ContextMouseEvent, StageInteractive, StageDraggable, Object2D } from "./Object2D.js";
...
export class CoordPoint extends StageDraggable {
...
export class CoordSystem extends StageInteractive {
    yup;
    color_axis;
    context;

    /** @type {Array<StageInteractive>} */ points = [];
