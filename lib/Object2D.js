...
class ContextTransf extends DU.SObject {
    /** @type {Vector2D} */ trans;
    /** @type {Vector2D} */ scale;
    /** @type {Rotation2D} */ rot;
    ...
    constructor( parameters = {}) {
        super();
        this.setValues(parameters,ContextTransf.DEF_PROP,false);
        if ("pos" in parameters) this.trans = parameters.pos;
        if ("stret" in parameters) this.scale = parameters.stret;
    }
...
class Object2D extends DU.SObject {
    ...
    setValues( parameters = {}, def = Object2D.DEF_PROP) {
        if ("uninitialized" in parameters && parameters.uninitialized) return;
    ...
    dispatchTickEvent(callback,settings = {}) {
        DU.SObject.insertValues(settings, Object2D.DEF_EVENT);
        /** @type {TickEvent} */
...
class StageObject extends Object2D {
    ...
    static DEF_PROP = DU.SObject.insertValues({
        mainBody: true,
...
class StageInteractive extends StageObject {
    ...
    /**
     * 
     * @param {StageObjectProperties} values 
     * @param {StageObjectProperties} def 
     * @returns 
     */
    setValues( values = {}, def = StageInteractive.DEF_PROP ) {
        super.setValues(values,def);
        return this;
    }
