...
export class Object2D {
     ...
     * @param {number} life 
     */
    constructor(x=0,y=0,rot=Object2D.DEF_ROTATION,
        scale=Object2D.DEF_SCALE.copy(),
        fillColor=Object2D.DEF_FILLCOLOR.copy(),
        borderColor=Object2D.DEF_BORDEDR_COLOR.copy(),
        borderWidth=Object2D.DEF_BORDER_WIDTH,
        graphics=Object2D.DEF_GRAPHICS,life=Object2D.DEF_LIFE) 
    {
...
class TempObject2D extends Object2D {
    life;
    update(delta=1) {
        super.update(delta);
        this.life -= 1 * delta;
...
export class SceneInteractive extends Object2D {
