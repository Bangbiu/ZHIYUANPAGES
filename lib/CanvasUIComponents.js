...
import { SceneObject, SceneInteractive, ContextMouseEvent } from "./SceneObject.js";
...
export class CanvasDisplayComponent extends SceneObject {

}

export class CanvasInterativeCompnent extends SceneInteractive {
