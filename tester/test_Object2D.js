...
export function run_Object2D() {
    ...
    obj1.addTickEventListener(function (ev) { this.rot.rad += 0.1; }, { interval: 10, repeat: -1 });
    let obj2 = obj1.clone();
    //obj1.log("tickEvents");
...
export function run_StageInteractive(canv) {
    ...
    obj2.add(obj1);
    obj1.addTickEventListener(function (ev) { this.rot.rad += 0.1; }, { interval: 5, repeat: -1 });
    obj1.msg();
    obj2.msg();
    renderList.push(obj1);
    renderList.push(obj2);
...
export function run_StateSwitching() {
    ...
    obj2.addTickEventListener(function (ev) { this.toggle(); }, { interval: 50, repeat: -1 });
    //obj2.switchTo(0);
    obj1.msg();
    obj2.msg();
    renderList.push(obj1);
